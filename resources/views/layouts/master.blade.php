            ...
            <div class="container">
                <div class="cta-image">
                    <div class="row pt-pb-2">
                        ...
                        <span class="text-right col-5"><button class="btn-white2"
                                style="color: #051f33; font-weight: 900;" onclick="openModal()">Get In
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('register.submit') }}" method="post">
                            ...
                            <div class="d-flex mt-10">
                                ...
                                <input class="form-control fs-14" type="text" id="remainingNumbers"
                                    name="remainingNumbers" placeholder="Phone Number">
                            </div>
                ...
                <div class="container">
                    <div class="row pl-2 pt-11 pb-4 d-flex">
                        <div class="col-12 footer-logo">
                            <img src="{{ asset('images/logo 2.png') }}" alt="Image 1" width="180px"
