...
<div class="col-9">
    <div class="p-2 b-radius-12 btn-secondary main-heading">
        <h6 class="text-left pl-1 mb-10">Trademark Details</h6>
    </div>

    <form class="text-left" method="POST" action="{{ route('store.step1') }}"
        ...
        <div class="box-2">
            <h4>What are you trying to Trademark?
                <a href="javascript:;" class="learn-more tooltip-wrap"><i class="ic-3 cl-iRed"></i><span
                        class="cl-iRed">Learn More</span>
            ...
            <ul class="check-list p-0 d-flex">
                <li class="w-auto">
                    <div class="custom-radio"><input value="Name" type="radio"><label for="" class="ml-2">Name</label>
                    </div>
                </li>
                <li class="w-auto">
                ...
                <li class="w-auto">
                    <div class="custom-radio"><input value="Logo" type="radio"><label for="" class="ml-2">Logo</label>
                    </div>
                </li>
                <li class="w-auto">
                    <div class="custom-radio"><input value="NameWithLogo" type="radio"><label for="" class="ml-2">Name
                            with
                            Logo</label></div>
                </li>
            </ul>
        ...
        <div class="box-2">
            ...
            <div class="fflex mb-3">
                ...
                <!-- <div>
                <a class="add-more t-dec-none" onclick="addInput()">
        ...
        <div class="box-2">
            ...
            <div class="custom-radio-options">
                <label><input type="radio" name="business_size" value="Individual"> <b> Individual </b> <small>(Planning
                        to
        ...
        <div class="box-2">
            ...
            <ul class="check-list d-flex p-0">
                <li class="w-auto">
                    <div class="custom-radio"><input value="USA" type="radio" name="us_based"><label for=""
                            class="ml-2">US</label></div>
                </li>
                <li class="w-auto">
                    <div class="custom-radio"><input value="CANADA" type="radio" name="us_based"><label for=""
                            class="ml-2">Canada
                            </label></div>
                </li>
                <li class="w-auto">
                    <div class="custom-radio"><input value="OTHER" type="radio" name="us_based"><label for=""
                            class="ml-2">Other
                            </label></div>
                </li>
            </ul>
