...
<form class="text-left" method="POST" action="{{ route('store.step2') }}">
    @csrf
    <div class="p-2 b-radius-12 btn-secondary main-heading col-12">
        <h6 class="text-left pl-1">Service Package</h6>
    </div>
    <div class="row">
        <div class="col-9">
            <div class="box-2 sty2 text-left">
                <h5 class="cl-iPrimary">Dear Test,</h5>
            ...
            <div class="box-2 px-0 pt-4">
                <h5 class="main-title">Select Legal Pro Trademark Service Package</h5>
                <span class="logoname">For Name & Logo <i class="far fa-edit pl-2"></i></span>
                <div>
                                        ...
                                        <div class="pck-bottomContent">
                                            ...
                                            <div class="quest-option">
                                                <p class="mb-15">Want to Get Your USPTO <br>Trademark Serial No.
                                                    <br><span class="clcpack-iRed">in 24 Hours?</span></p>
                                                <div class="chck-row">
                                                    <input class="form-check-input" type="checkbox" id="id1" checked="">
                                                ...
                                                <div class="chck-row">
                                                    <input class="form-check-input" type="checkbox" id="id2" checked="">
                                        ...
                                        <div class="pck-bottomContent">
                                            ...
                                            <div class="quest-option">
                                                <p class="mb-15">Want to Get Your USPTO <br>Trademark Serial No.
                                                    <br><span class="clcpack-iRed">in 24 Hours?</span></p>
                                                <div class="chck-row">
                                                    <input class="form-check-input" type="checkbox" id="id3" checked="">
                                                ...
                                                <div class="chck-row">
                                                    <input class="form-check-input" type="checkbox" id="id4" checked="">
                                        ...
                                        <div class="pck-bottomContent">
                                            ...
                                            <div class="quest-option">
                                                <p class="mb-15">Want to Get Your USPTO <br>Trademark Serial No.
                                                    <br><span class="clcpack-iRed">in 24 Hours?</span></p>
                                                <div class="chck-row">
                                                    <input class="form-check-input" type="checkbox" id="id5" checked="">
                                                ...
                                                <div class="chck-row">
                                                    <input class="form-check-input" type="checkbox" id="id6" checked="">
                                ...
                                <div class="package-box package-4">
                                    ...
                                    <div class="pck-content">
                                        ...
                                        <div class="pck-bottomContent">
                                            ...
                                            <p class="mb-15">GET USPTO Serial No. in - <span class="hl-days bgc-iRed">3
                                                    Days</span></p>
                                            <div class="quest-option">
                                                <p class="mb-15">Want to Get Your USPTO Trademark Serial No. <span
                                                        class="clcpack-iRed">in 24 Hours?</span></p>
                                                <div class="chck-row">
                                                    <input class="form-check-input" type="checkbox" id="id7" checked="">
                                                ...
                                                <div class="chck-row">
                                                    <input class="form-check-input" type="checkbox" id="id8" checked="">
            ...
            <div class="box-2">
                <div class="ps-relative pb-5">
                    <div class="fflex mb-3">
                        <h5 class="mb-0"><input type="checkbox" class="mr-2 ng-untouched ng-pristine ng-valid">Legal Pro Trademark
                            Search <span class="cus-tooltip ps-absolute sty2 mr-2 is--active"><span
                    ...
                    <p class="para text-left">Legal Pro Trademark Search is your gateway to more than 1 billion
                        ...
                        added
                        in your
                        trademark search package. </p><br><br>
                    <div class="row align-items-center ps-relative">
                        <div class="col-lg-10">
                            <ul class="check-list ls-none">
                                <li>
                                    <div class="custom-radio sty1"><input type="radio" id="service1" value="federal"
                                            name="packageSelect3"><label for="" class="cl-black ml-2">Federal &amp;
                                            State
                                ...
                                <li>
                                    <div class="custom-radio sty1"><input type="radio" id="service2"
                                            ...
                                            <span class="tag tag-yellow ml-2">Best Seller</span>
                                        </label></div>
                                </li>
                                <li>
                                    <div class="custom-radio sty1"><input type="radio" id="service3"
                                            ...
                                            <strong>$499</strong><span class="tag tag-pink ml-2">Recommended</span>
                                        </label></div>
                                </li>
                            </ul>
                        </div>
