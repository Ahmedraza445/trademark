    ...
    <div class="container">
        <div class="row p-5">
            <div class="w-70 text-center text-white">
                ...
                <p>In short, yes - as long as it avoids causing consumer confusion. Keep in mind that commonly used
                    phrases, names, or Symbols may face a higher likelihood of refusal.</p>

                <div class="mt-4">
                    <button class="btn-white2" onclick="openModal()">Register Now!</button>
                </div>
            </div>
        </div>
    </div>
